                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <fieldset class="form-group">
                                                    <label for="room_id" class="mb-2 d-flex align-items-center"><span class="required">*</span> Room Number</label>
                                                    <select name="room_id" class="form-select select2" style="width: 100%" required>
...
<script>
    $("#createForm").validate({
        ...
        messages:{
            ...
            room_id: "Room number is required",
