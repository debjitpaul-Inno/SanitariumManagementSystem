                            ...
                            <form id="editForm" class="form form-vertical" action="{{route('bed-list.update', $bedList->uuid)}}" method="POST">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <fieldset class="form-group">
                                                <label for="room_id" class="mb-2 d-flex align-items-center">Room Number</label>
                                                <select name="room_id" class="form-select select2" style="width: 100%">
                                                    @foreach($rooms as $room)
                                                        <option value="{{ $room->id }}" {{$bedList->room_id == $room->id  ? 'selected' : ''}}>{{ $room->room_number }}</option>
                                                    @endforeach
                                                </select>
                                            </fieldset>
...
<script>
    $("#editForm").validate({
        ...
        messages:{
            ...
            room_id: "Floor Number is required",
