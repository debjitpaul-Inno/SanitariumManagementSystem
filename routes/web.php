...
Route::get('/appointment-for-today', [PatientAppointmentController::class, 'appointments'])->name('appointment-for-today.appointments');
...
//Services
Route::middleware(['permission'])->group(function () {
    Route::resource('service', ServiceController::class)->middleware( 'verified');
});


//Package
Route::middleware(['permission'])->group(function () {
    Route::resource('package', PackageController::class)->middleware( 'verified');
});
...
//Ward
Route::middleware(['permission'])->group(function () {
Route::resource('ward', WardController::class)->middleware('verified');
});

//Room Type
Route::middleware(['permission'])->group(function () {
Route::resource('room-type', RoomTypeController::class)->middleware('verified');
});

//Room
Route::middleware(['permission'])->group(function () {
Route::resource('room', RoomController::class)->middleware('verified');
});
