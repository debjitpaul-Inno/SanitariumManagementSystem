...
//            ],
            ...
            [
                ...
                "slug" => 'room-type.index',
            ],
            [
                "title" => 'Room Type Create View',
                "slug" => 'room-type.create',
            ],
            [
                "title" => 'Create Room Type',
                "slug" => 'room-type.store',
            ],
            [
                "title" => 'Room Type Edit View',
                "slug" => 'room-type.edit',
            ],
            [
                "title" => 'Update Room Type',
                "slug" => 'room-type.update',
            ],
            [
                "title" => 'Delete Room Type',
                "slug" => 'room-type.destroy',
            ],
            [
