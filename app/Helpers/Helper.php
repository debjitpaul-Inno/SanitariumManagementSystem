...
//                    [
//                        'sideIcon' => '',
//                        'title' => 'Add Doctor Percentage',
//                        'link' => route('doctor-percentage.create'),
//                        'permission' => 'doctor-percentage.create',
//                    ],
//                ],
//            ],
            [
...
////                    ],
            ...
            [
                'sideIcon' => 'command',
                'title' => 'Ward',
                'link' => route('ward.index'),
                'hasSub' => false,
                'subMenu' => [],
                'permission' => 'ward.index',
            ],
            [
                'sideIcon' => 'codesandbox',
                'title' => 'Room Manager',
                'link' => '',
                'hasSub' => true,
                ...
                'subMenu' => [
                    [
                        'sideIcon' => '',
                        'title' => 'Room Type ',
                        'link' => route('room-type.index'),
                        'permission' => 'room-type.index',
                    ],
